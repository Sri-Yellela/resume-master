...
| | |
|---|---|
| deployed commit | `4643e20` — equals local `main`, nothing unshipped |
...
| test baseline | **2626 tests, 2624 pass, 2 fail** — the two failures are deliberate, see `CLAUDE.md` |
...
- **Local:** `npm test`. Expect 2619 / 2617 / 2, and check `CLAUDE.md` before assuming a red is rot.
